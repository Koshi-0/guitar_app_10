...
def start_recording():
    ...
    if input_device_index is not None:
        ...
        wf = wave.open(os.path.join(app.config['UPLOAD_FOLDER'], WAVE_OUTPUT_FILENAME), 'wb')
...
def upload_file():
    audio_file = os.path.join(app.config['UPLOAD_FOLDER'], WAVE_OUTPUT_FILENAME)

    # スペクトログラムの作成
    spectrogram_file = convert_to_spectrogram(audio_file, app.config['UPLOAD_FOLDER'])
